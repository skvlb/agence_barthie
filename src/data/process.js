...
export const processSteps = [
  ...
  },
  {
    ...
    description: {
      fr: 'Nous analysons avec précision vos besoins et objectifs et les spécificités de votre évènement. Cette évaluation détaillée nous permet d\'élaborer une réponse cohérente, adapté à votre demande et votre budget.',
      en: 'We precisely analyze your needs, objectives, and the specificities of your event. This detailed evaluation allows us to develop a coherent response, adapted to your request and your budget.'
    }
  },
  {
    title: {
      fr: 'PROPOSITION D\'OFFRE(S)',
      en: 'PROPOSAL SUBMISSION'
    },
    description: {
      fr: 'Nous vous transmettons une proposition sur-mesure. Chaque offre et conçue pour refléter l\'image de votre évènement et valoriser votre expérience.',
